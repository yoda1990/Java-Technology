package org.hmily.keepalive.server.websocket.handler;
...
import org.hmily.keepalive.server.websocket.utils.ConnectionStore;
...
public class NewConnectHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        ConnectionStore.saveConnection(userId, ctx.channel()); // 保存连接
        // 结束
    }
}
